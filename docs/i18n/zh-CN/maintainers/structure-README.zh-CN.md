...
| 中文（`zh-CN`） | `README.md` / `docs/README.md` | `docs/i18n/zh-CN/` | 部分本地化文章；导航请使用英文入口。 |
| 日文（`ja`） | `README.md` / `docs/README.md` | `docs/i18n/ja/` | 部分本地化文章；导航请使用英文入口。 |
| 俄文（`ru`） | `README.md` / `docs/README.md` | `docs/i18n/ru/` | 部分本地化文章；导航请使用英文入口。 |
| 法文（`fr`） | `README.md` / `docs/README.md` | `docs/i18n/fr/` | 部分本地化文章；导航请使用英文入口。 |
